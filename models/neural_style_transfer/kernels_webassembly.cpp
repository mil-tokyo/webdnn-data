...
int meta_buf_3[] = {7808,7840,7776,8705667,5526147,32,32,32,27648};
int meta_buf_4[] = {5526147,1987203,1,32,144,192,72,96,4,4,1,1,2,2,1,1};
int meta_buf_5[] = {1987203,7872,5968515,6912,64,512};
int meta_buf_6[] = {40768,40640,40704,5968515,5526147,64,64,64,6912};
int meta_buf_7[] = {5526147,1987203,1,64,72,96,36,48,4,4,1,1,2,2,1,1};
int meta_buf_8[] = {1987203,40832,6189699,1728,128,1024};
int meta_buf_9[] = {172032,172160,171904,6189699,5968515,128,1728,128,1728};
int meta_buf_10[] = {5968515,6853251,1728,128,128,1728};
int meta_buf_11[] = {6853251,1987203,1,128,36,48,36,48,3,3,1,1,1,1,1,1};
int meta_buf_12[] = {1987203,172288,6410883,1728,128,1152};
int meta_buf_13[] = {319872,319744,6410883,6632067,128,128,128,1728};
int meta_buf_14[] = {6632067,1987203,1,128,36,48,36,48,3,3,1,1,1,1,1,1};
int meta_buf_15[] = {1987203,320000,6189699,1728,128,1152};
int meta_buf_16[] = {467456,467584,5968515,6189699,5968515,1728,128,1728,128,1728};
int meta_buf_17[] = {5968515,6189699,1728,128,128,1728};
int meta_buf_18[] = {6189699,1987203,1,128,36,48,36,48,3,3,1,1,1,1,1,1};
int meta_buf_19[] = {1987203,467712,6410883,1728,128,1152};
int meta_buf_20[] = {615296,615168,6410883,6189699,128,128,128,1728};
int meta_buf_21[] = {6189699,1987203,1,128,36,48,36,48,3,3,1,1,1,1,1,1};
int meta_buf_22[] = {1987203,615424,6189699,1728,128,1152};
int meta_buf_23[] = {763008,762880,5968515,6189699,6853251,1728,128,1728,128,1728};
int meta_buf_24[] = {6853251,7074435,1728,128,128,1728};
int meta_buf_25[] = {7074435,1987203,1,128,36,48,36,48,3,3,1,1,1,1,1,1};
int meta_buf_26[] = {1987203,763136,6632067,1728,128,1152};
int meta_buf_27[] = {910592,910720,6632067,6189699,128,128,128,1728};
int meta_buf_28[] = {6189699,1987203,1,128,36,48,36,48,3,3,1,1,1,1,1,1};
int meta_buf_29[] = {1987203,910848,5968515,1728,128,1152};
int meta_buf_30[] = {1058432,1058304,6853251,5968515,7074435,1728,128,1728,128,1728};
int meta_buf_31[] = {7074435,7295619,1728,128,128,1728};
int meta_buf_32[] = {7295619,1987203,1,128,36,48,36,48,3,3,1,1,1,1,1,1};
int meta_buf_33[] = {1987203,1058560,5968515,1728,128,1152};
int meta_buf_34[] = {1206016,1206144,5968515,5968515,128,128,128,1728};
int meta_buf_35[] = {5968515,1987203,1,128,36,48,36,48,3,3,1,1,1,1,1,1};
int meta_buf_36[] = {1987203,1206272,7295619,1728,128,1152};
int meta_buf_37[] = {1353856,1353728,7295619,7074435,6853251,128,1728,1728,128,1728};
int meta_buf_38[] = {6853251,6189699,1728,128,128,1728};
int meta_buf_39[] = {6189699,1987203,1,128,36,48,36,48,3,3,1,1,1,1,1,1};
int meta_buf_40[] = {1987203,1353984,6632067,1728,128,1152};
int meta_buf_41[] = {1501568,1501440,6632067,6632067,128,128,128,1728};
int meta_buf_42[] = {6632067,1987203,1,128,36,48,36,48,3,3,1,1,1,1,1,1};
int meta_buf_43[] = {1987203,1501696,6410883,1728,128,1152};
int meta_buf_44[] = {1649280,1649152,6410883,6853251,6189699,128,1728,128,128,1728};
int meta_buf_45[] = {6189699,1649408,1987203,1728,1024,128};
int meta_buf_46[] = {5526147,1987203,1,36,48,64,72,96,4,4,2,2,1,1};
int meta_buf_47[] = {1780544,1780608,1780480,5526147,5968515,64,64,64,6912};
int meta_buf_48[] = {5968515,1780672,1987203,6912,512,64};
int meta_buf_49[] = {5526147,1987203,1,72,96,32,144,192,4,4,2,2,1,1};
int meta_buf_50[] = {1813440,1813504,1813472,5526147,8705667,32,32,32,27648};
int meta_buf_51[] = {8705667,1813536,1987203,27648,243,32};
int meta_buf_52[] = {8705667,1987203,1,144,192,3,144,192,9,9,1,1,4,4};
int meta_buf_53[] = {1821315,1821312,1904259,8705667,7295619,27648,27648,3,27648,3,27648};
...
void fusedelementwise_d3d00754ed0a5a1f84fd08b998cf3b070e7d734f4f2b0cb564730dfb(const int * meta_buffer)
{
    const float * v1 = (static_buffer + meta_buffer[0]);
...
void fusedelementwise_d5bd27fce1f9d9177d647b04076fb0d81c964a7dc5e1ab767aa9be37(const int * meta_buffer)
{
    const float * v1 = (static_buffer + meta_buffer[0]);
    const float * v2 = (static_buffer + meta_buffer[1]);
    const float * v3 = (static_buffer + meta_buffer[2]);
...
void fusedelementwise_341090a86562c4316ca60ca58c61ad9f23438c0ddd99da536c7a5b23(const int * meta_buffer)
{
    const float * v1 = (static_buffer + meta_buffer[0]);
    const float * v2 = (static_buffer + meta_buffer[1]);
    const float * v3 = (static_buffer + meta_buffer[2]);
...
void fusedelementwise_d842bec6f9f775690c02e6cf4e89062b4c53ad028ad0e422f3b28bab(const int * meta_buffer)
{
    const float * v1 = (static_buffer + meta_buffer[0]);
    const float * v2 = (static_buffer + meta_buffer[1]);
    const float * v3 = (static_buffer + meta_buffer[2]);
...
void fusedelementwise_8ef82460e76cd0645afaa06eb5a4cfcb6ff5ec49c54ec5efe205b819(const int * meta_buffer)
{
    const float * v1 = (static_buffer + meta_buffer[0]);
    const float * v2 = (static_buffer + meta_buffer[1]);
    const float * v3 = (static_buffer + meta_buffer[2]);
...
void fusedelementwise_a64aafa2f6769841a013abb67ba916f124f1805a9a5427699a52a40d(const int * meta_buffer)
{
    const float * v1 = (static_buffer + meta_buffer[0]);
    const float * v2 = (static_buffer + meta_buffer[1]);
    const float * v3 = (static_buffer + meta_buffer[2]);
...
void fusedelementwise_d0f7af04cac8aa73e8a47fb4ee13387520a9e7b39368d7d90bb28b74(const int * meta_buffer)
{
    const float * v1 = (static_buffer + meta_buffer[0]);
    const float * v2 = (static_buffer + meta_buffer[1]);
    const float * v3 = (static_buffer + meta_buffer[2]);
    ...
    for (d0 = ((1 > 8) ? (0 % (1 / 8)) : 0); d0 < D0; d0 += ((1 > 8) ? (1 / 8) : 1)) {
        ...
        for (d1 = ((1 > 8) ? (0 / (1 / 8)) : 0); d1 < D1; d1 += ((1 > 8) ? 8 : 1)) {
            ...
            const float v15 = v3[d0*v7 + d1];
            float v16;
            {
                v16 = v14 * v15;
            }
            const float v17 = v1[d0*v6 + d1];
            float v18;
            {
                v18 = v16 + v17;
            }
...
fusedelementwise_d3d00754ed0a5a1f84fd08b998cf3b070e7d734f4f2b0cb564730dfb(meta_buf_3);
...
fusedelementwise_3a4ef8c9c147fce2d26f9f7d2455b87804e4b567e345be70573011f4(meta_buf_6);
...
fusedelementwise_d5bd27fce1f9d9177d647b04076fb0d81c964a7dc5e1ab767aa9be37(meta_buf_9);
...
fusedelementwise_341090a86562c4316ca60ca58c61ad9f23438c0ddd99da536c7a5b23(meta_buf_16);
...
fusedelementwise_76b9dc92c2fb5c2a9a65e1ad1b5a701bf4a62fb9bf57f1cb528782c1(meta_buf_20);
...
fusedelementwise_38c1ade3e3f960fda14ca2ef77953bd87bf628de20269b465824a1fd(meta_buf_23);
...
fusedelementwise_26dd77e74b458d68edc3d003daf7cf86ada86d3bc47184d7d00922e1(meta_buf_34);
...
fusedelementwise_d842bec6f9f775690c02e6cf4e89062b4c53ad028ad0e422f3b28bab(meta_buf_37);
...
fusedelementwise_8ef82460e76cd0645afaa06eb5a4cfcb6ff5ec49c54ec5efe205b819(meta_buf_44);
...
fusedelementwise_d3d00754ed0a5a1f84fd08b998cf3b070e7d734f4f2b0cb564730dfb(meta_buf_47);
...
fusedelementwise_a64aafa2f6769841a013abb67ba916f124f1805a9a5427699a52a40d(meta_buf_50);
...
fusedelementwise_d0f7af04cac8aa73e8a47fb4ee13387520a9e7b39368d7d90bb28b74(meta_buf_53);
